    ...
    <div className="space-y-6 animate-in fade-in duration-300">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-cyan-400 os-live-dot" />
            ...
            <h2 className="text-2xl font-bold text-white os-mono">Event Ingestion, Anomaly Sensing & Risk Detection</h2>
          ...
          {/* Filter Bar */}
          <div className="flex flex-wrap items-center gap-2 os-mono text-xs">
            {/* Domain Filter */}
            <select
              value={selectedDomain}
              onChange={(e) => setSelectedDomain(e.target.value)}
              className="px-2.5 py-1.5 rounded-lg bg-black/50 border border-white/10 text-white focus:outline-none focus:border-cyan-500 os-mono text-xs"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 space-y-2.5">
          <span className="text-xs os-mono uppercase tracking-wider text-slate-400">
            ...
            {filteredEvents.map((ev) => {
              ...
              return (
                <div
                  ...
                  className={`p-3.5 rounded-lg os-surface os-interactive space-y-2 cursor-pointer ${
                    isSelected
                      ? 'border-cyan-500/60 bg-cyan-950/20 shadow-[0_0_16px_rgba(6,182,212,0.15)]'
                      : ''
                  }`}
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span
                      className={`text-[9px] os-mono px-1.5 py-0.2 rounded font-bold uppercase shrink-0 ${
                  ...
                  <div className="flex items-center justify-between text-[10px] os-mono text-slate-500 pt-1 border-t border-white/[0.04]">
        ...
        {activeEvent && (
          <div className="lg:col-span-6 space-y-4 p-4 lg:p-5 rounded-xl os-glass">
            <div className="space-y-2 pb-3 border-b border-white/[0.06]">
              <div className="flex items-center justify-between">
                <span
                  className={`text-[10px] os-mono px-2 py-0.5 rounded font-bold uppercase ${
                ...
                <span className="text-xs os-mono text-slate-400">{activeEvent.timestamp}</span>
              </div>
              <h3 className="text-base font-bold text-white os-mono">{activeEvent.summary}</h3>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-200 leading-relaxed p-3.5 rounded-lg os-surface os-mono">
                {activeEvent.details}
              </p>
            </div>

            <div className="grid grid-cols-2 gap-3 text-xs os-mono">
              <div className="p-3 rounded-lg os-surface">
                <div className="text-[10px] text-slate-400 uppercase">Origin Source</div>
                <div className="text-slate-200 font-bold mt-0.5">{activeEvent.source}</div>
              </div>
              <div className="p-3 rounded-lg os-surface">
                <div className="text-[10px] text-slate-400 uppercase">Target Entity</div>
            ...
            {activeEvent.recommendedAction && (
              <div className="p-4 rounded-lg bg-gradient-to-br from-[#121826] to-[#0c1017] border border-cyan-500/30 space-y-3">
                <div className="flex items-center gap-2 text-xs os-mono font-bold text-cyan-400 uppercase">
                ...
                <button
                  ...
                  className="w-full py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold os-mono flex items-center justify-center gap-1.5 transition-all shadow-[0_0_12px_rgba(16,185,129,0.3)]"
                >
