      ...
      <div className="p-4 lg:p-5 rounded-xl os-glass-strong os-cyber-corners border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.6)]">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="space-y-1">
            ...
            <h2 className="text-2xl font-bold text-white os-mono">Execution Authorization &amp; Immutable Audit Ledger</h2>
        ...
        {/* Tab Selector */}
        <div className="flex items-center gap-2 mt-4 pt-4 border-t border-white/[0.06] os-mono text-xs">
          <button
      ...
      {activeTab === 'pending' && (
        <div className="p-4 lg:p-5 rounded-xl os-glass space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] os-mono text-slate-400">Deterministic simulation verified</span>
          </div>

          {pendingActions.length === 0 ? (
            <div className="p-8 text-center text-xs os-mono text-slate-500 bg-black/20 rounded-lg border border-white/[0.04]">
            ...
            <div className="space-y-3">
              {pendingActions.map((action) => (
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs os-mono text-slate-400">Target: {action.targetSystem}</span>
                        <span className="text-[10px] os-mono px-1.5 py-0.2 rounded bg-white/[0.04] text-slate-300">
                          Reversible: Yes
                        </span>
                      </div>
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold flex items-center gap-1.5 transition-all shadow-[0_0_12px_rgba(16,185,129,0.3)] os-mono shrink-0"
                    >
                  ...
                  <div className="p-3 rounded-lg bg-[#06090e] border border-cyan-500/30 text-xs os-mono text-slate-300 space-y-1">
      ...
      {activeTab === 'ledger' && (
        <div className="p-4 lg:p-5 rounded-xl os-glass space-y-4">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[11px] os-mono text-slate-400">Cryptographically auditable</span>
          </div>
          ...
          <div className="space-y-3">
            {executionRecords.map((rec) => (
              <div
                key={rec.id}
                className="p-3.5 rounded-lg os-surface os-interactive flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs os-mono"
              >
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
      ...
      {activeTab === 'policies' && (
        <div className="p-4 lg:p-5 rounded-xl os-glass space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="p-4 rounded-lg os-surface space-y-2">
              <div className="text-xs font-bold text-white os-mono">1. Financial Ceiling</div>
            ...
            <div className="p-4 rounded-lg os-surface space-y-2">
              <div className="text-xs font-bold text-white os-mono">2. Customer Communication</div>
              <p className="text-xs text-slate-400">
            ...
            <div className="p-4 rounded-lg os-surface space-y-2">
              <div className="text-xs font-bold text-white os-mono">3. Production Deployments</div>
              <p className="text-xs text-slate-400">
