...
export const ExecutiveCockpit: React.FC<ExecutiveCockpitProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-6 rounded-3xl bg-gradient-to-r from-[#0c101c] to-[#080a10] border border-cyan-500/30 shadow-[0_12px_40px_rgba(0,0,0,0.8)]">
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-white/[0.06] hover:bg-white/[0.12] text-xs font-mono font-bold text-slate-300 hover:text-white border border-white/10 transition-all shrink-0"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="p-6 rounded-3xl bg-[#0a0d16] border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.6)] space-y-3">
          ...
          <div className="text-xs text-slate-400 font-sans flex items-center justify-between">
            ...
            <button
              ...
              className="text-cyan-400 text-[11px] font-mono hover:underline flex items-center gap-1"
            >
      ...
      <div className="rounded-3xl bg-[#0a0d16] border border-white/[0.1] p-6 sm:p-8 space-y-6 shadow-[0_16px_48px_rgba(0,0,0,0.7)]">
        ...
        <div className="space-y-4">
          {topPriorities.map((item) => (
            <div
              key={item.id}
              className="p-5 rounded-2xl bg-white/[0.02] border border-white/[0.06] hover:border-cyan-500/40 transition-all flex flex-col lg:flex-row lg:items-center justify-between gap-4"
            >
              <div className="space-y-1.5 min-w-0 max-w-2xl">
                <div className="flex items-center gap-2">
                  <span className="px-2 py-0.5 rounded font-mono text-xs font-bold bg-cyan-500/20 text-cyan-300">
                    {item.num}
                  </span>
              ...
              <div className="flex items-center gap-3 shrink-0 pl-8 lg:pl-0">
                {item.objectiveId && (
                  <button
                    ...
                    className="px-3.5 py-2 rounded-xl bg-white/[0.04] hover:bg-white/[0.08] text-xs font-mono text-slate-300 border border-white/10 transition-all"
                  >
                    Investigate Context
                  </button>
                )}
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-mono font-bold flex items-center gap-1.5 shadow-[0_0_16px_rgba(16,185,129,0.3)] transition-all"
                >
